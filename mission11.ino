...
#define _DIST_ALPHA 0.2 // ema 수치를 측정하기 위한 가중치 상수 설정
...
// get a distance reading from the USS
  ...
  dist_ema = (alpha * dist_raw) + ((1 - alpha) * dist_ema); // ema값 측정
...
if(dist_raw <= 180.0) {
     ...
     myservo.writeMicroseconds((_DUTY_MIN) + ((dist_raw - 180.0) * 9.0));
